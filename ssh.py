...
def runall():
    while True:
        ssh_pi_aqi('172.19.188.73','root','root','tail -1 /home/aqi/out.txt')
        ssh_pi_temp('172.19.188.73','root','root','tail -1 /home/humandity/tm.out')
        ssh_pi_co_co2('172.19.188.73', 'pi', 'root', 'tail -1 /home/pi/co/co.out')
        time.sleep(3)
